...
export const titulo =
  "3D Artist / Unreal Engine Developer / Web Developer";
...
// Dynamic years of experience since July 2015.
const YEARS_START_DATE = new Date(2015, 6, 1); // Month is 0-based (6 = July)
...
export const resumeData: ResumeData = {
  ...
  education: [
    ...
    },
    {
      ...
      datos: [
        ...
        "Unreal 5 Materials - Part 4 Post Process Materials",
  ...
  skills: [
    ...
    { skill: "Gitlab", level: "Intermediate" },
